...
SdmxJsonCatalogItem.defaultPropertiesForSharing.push('regionConcept');
SdmxJsonCatalogItem.defaultPropertiesForSharing.push('regionTypeConcept');
...
function rebuildData(item) {
    ...
    return loadJson(item.url).then(function(json) { console.log(json); });
